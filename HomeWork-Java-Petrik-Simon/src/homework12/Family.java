...
public class Family  implements Serializable {
    ...
    public String toStringForOneFamily() {
        return "Family{" +
                "mother=" + mother +
                ", father=" + father +
