...
import static homework8.Human.countFamily;
...
//        }
       ...
       Human fatherFamily2 = new Human("Vitaliy", "Korenev", 35, 99, scheduleFather);
        ...
        CollectionFamily collectionFamily = new CollectionFamily();
        System.out.println("Collection family - " + collectionFamily);


        FamilyService familyService = new FamilyService(collectionFamily);
        System.out.println("After");
        familyService.getAllFamilies();
        System.out.println("familyServicey - " + familyService);
